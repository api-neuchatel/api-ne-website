        ...
        easyResponsiveTabs: function (options) {
            ...
            this.each(function () {
                ...
                $respTabs.find('.resp-accordion').each(function () {
                    ...
                    $tabItemh2.attr('id', 'tab_head_' + (itemCount+1));
                    itemCount++;
                });
                ...
                //Active correct tab
                jQuery($respTabs.find('.resp-tab-item')[tabNum]).addClass('resp-tab-active');

                //keep closed if option = 'closed' or option is 'accordion' and the element is in accordion mode
                if(options.closed !== true && !(options.closed === 'accordion' && !$respTabsList.is(':visible')) && !(options.closed === 'tabs' && $respTabsList.is(':visible'))) {                  
                    jQuery($respTabs.find('.resp-accordion')[tabNum]).addClass('resp-tab-active');
                    jQuery($respTabs.find('.resp-tab-content')[tabNum]).addClass('resp-tab-content-active').attr('style', 'display:block');
                }
                //assign proper classes for when tabs mode is activated before making a selection in accordion mode
                else {
                    jQuery($respTabs.find('.resp-tab-content')[tabNum]).addClass('resp-tab-content-active resp-accordion-closed')
                }
...
(function($) {
  $.easyPieChart = function(el, options) {
    ...
    drawLine = function(percent) {
      ...
      _this.ctx.lineWidth = _this.options.lineWidth+1;
      offset = _this.options.size / 2 - _this.options.lineWidth / 2;
      if (_this.options.scaleColor !== false) {
        offset -= _this.options.size * 0.08;
      }
